        ...
        if ("p1".equals(playerId)) {
            ...
            if (promoted != null) {
                try {
                    ...
                    System.out.println("P2 promoted to P1 in room " + room.roomCode);
                } catch (Exception e) {
                    System.out.println(" Failed to notify promoted P1: " + e.getMessage());
                }
            }
...
private void autoSetupSpawn(GameRoom room, String playerId) {
    ...
    try {
        ...
        System.out.println(" autoSetupSpawn parse error: hexKey='"
                + hexKey + "' → " + e.getMessage());
    }
}
    ...
    private void broadcastRoom(GameRoom room, Map<String, Object> msg) {
        try {
            ...
            System.out.println(" broadcastRoom error: " + e.getMessage());
        }
    }
