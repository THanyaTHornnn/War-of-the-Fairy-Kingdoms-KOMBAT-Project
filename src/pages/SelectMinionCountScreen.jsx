...
// // ============================================================
// // 🔧 EDIT HERE: min/max จำนวน minion ที่เลือกได้
// // ============================================================
// const MIN_COUNT = 1;
// const MAX_COUNT = 5;

// // ตัวอย่าง minions ที่แสดงในแต่ละ card (ตาม Figma: 1=1ตัว, 2=2ตัว, ...)
...
//     setTimeout(() => {
//       // ============================================================
//       // 🔧 EDIT HERE: ส่ง minionCount ไป backend → API call ตรงนี้
//       // ============================================================
//       setGameState(prev => ({ ...prev, minionCount: count }));
//       onNext("collection");
//     }, 300);
//   };
...
//                 // ============================================================
//                 // 🔧 EDIT HERE: แทน MinionCharacter ด้วยรูปจริงถ้ามี
//                 // ============================================================
